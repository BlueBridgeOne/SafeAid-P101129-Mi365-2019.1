	...
	,	getVisibleOptions: function getVisibleOptions()
		{
			var collection = this.get('options')
					.filter(function(option)
					{
								...
								return option.get('cartOptionId')!="custcol_bb1_sca_area2"&&option.get('cartOptionId')!="custcol_bb1_sca_wearer2"&&option.get('cartOptionId')!="custcol_bb1_sca_area"&&option.get('cartOptionId')!="custcol_bb1_sca_wearer"&&option.get('cartOptionId')!="cseg_bb1_brand";
