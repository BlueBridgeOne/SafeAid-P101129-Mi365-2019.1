			...
			<div class="order-history-details-header-col-left">
				<p class="order-history-details-header-date-info">
					...
					<p class="order-history-details-header-purchase-order-number-info">
						{{translate '<span class="order-history-details-header-purchase-order-info-purchase-order-number-label">Purchase Order Number: </span> <span class="order-history-details-header-purchase-order-number">$(0)</span>' model.purchasenumber}} {{#if allowEditPO}}<a data-action="editPO">{{translate 'Edit'}}</a>{{/if}}
					</p>
