							...
							<ul class="header-menu-level2">
								...
								<li>
									...
									<ul class="header-menu-level3">
										...
										{{#ifEquals text "First Aid"}}
										<li>
											<a class="{{class}}" data-navigation="ignore-click" target="_new" href="http://www.safeaidsuppliessigns.com/">{{translate "More Signs"}} <i class="external-link-icon"></i></a>
										</li>
										{{/ifEquals}}
										{{/each}}
									</ul>
