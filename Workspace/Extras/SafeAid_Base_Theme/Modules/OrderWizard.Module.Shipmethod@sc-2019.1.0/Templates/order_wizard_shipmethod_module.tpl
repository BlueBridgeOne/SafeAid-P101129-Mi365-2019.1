<div class="order-wizard-shipmethod-module">
	...
	<select data-action="select-delivery-option" data-action="edit-module"
		...
		<option {{#if isActive}}selected{{/if}} value="{{internalid}}" id="delivery-options-{{internalid}}">
			{{rate_formatted}} - {{name}}
		</option>
		{{/each}}
	</select>
	...
	<a data-action="select-delivery-option-radio"
		...
		<input type="radio" name="delivery-options" data-action="edit-module"
			class="order-wizard-shipmethod-module-checkbox" {{#if isActive}}checked{{/if}} value="{{internalid}}"
	...
	<div class="address-edit-fields-group" data-input="custbody_bb1_sca_deliverynote" data-validation="control-group">
		<label class="address-edit-fields-group-label" for="custbody_bb1_sca_deliverynote">
			{{translate 'Enter your delivery instructions below'}} <span
				class="address-edit-fields-input-optional">(optional)</span>
		</label>
		<div class="address-edit-fields-group-form-controls" data-validation="control">
			<textarea class="address-edit-fields-group-input" id="custbody_bb1_sca_deliverynote"
